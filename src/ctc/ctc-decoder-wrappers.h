...
#ifndef KALDI_CTC_CCTC_DECODER_WRAPPERS_H_
#define KALDI_CTC_CCTC_DECODER_WRAPPERS_H_
...
// (so needed to be adapted to use CtcTransitionModel).
...
bool DecodeUtteranceLatticeFasterCtc(
  ...
  const ctc::CtcTransitionModel &trans_model,
